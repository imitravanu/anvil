...
// Max allowed diff percentage (default 2.5% to tolerate cross-OS FreeType anti-aliasing per spec Non-Goals)
const DIFF_THRESHOLD_PERCENT = Number(process.env.VISUAL_THRESHOLD || 2.5);

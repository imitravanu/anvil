...
export const MODEL_REGISTRY: ModelInfo[] = [
  ...
  },
  {
    ...
    contextWindow: 128_000,
    // Live-probed 2026-09-22: streams fine, but a direct tool prompt produced
    // prose instead of a tool_call (reasoning models often prefer explaining
    // over invoking). Tools not reliably callable — keep default-pick away.
    supportsTools: false,
    supportsVision: false,
    isFree: true,
    certified: "live",
